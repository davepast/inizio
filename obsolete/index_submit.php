...
<main role="main" class="container">
    <h1>Vyhledání subjektu pomocí IČO přes ARES (GET)</h1>
    <div class="starter-template">
        <div class="container">
            <form action="index_submit.php" method="get">
                <label>IČO:
                    <input class="form-control form-control-sm" type="number" name="ico" placeholder="Zadejte IČO">
                </label>
                <button class="btn btn-success">Hledat</button>
            </form>
            ...
            include('function/xml2array.php');

            if (!isset($_GET['ico']) || $_GET['ico'] == "" || !(int) $_GET['ico']) {
            ...
            if (isset($contents)){
                file_put_contents('save/' . date('YmdHis', time()) . $_GET['ico'] . '.xml', $contents);
            }
            ?>
        </div>
    </div>
